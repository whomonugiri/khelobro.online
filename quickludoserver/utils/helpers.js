  ...
  try {
    ...
    if (
      ...
      if (greenteam.life < 0 || greenteam.exit) {
        ...
        ob.looserScore = blueteam.score;
        ob.looserId = blueteam.userId;
      } else if (blueteam.score == greenteam.score) {
        ob.winnerColor = null;
        ob.winnerScore = blueteam.score;
        ob.winnerId = null;
        ob.looserColor = null;
