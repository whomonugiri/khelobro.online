          ...
          {accordionData.map((item, index) => (
            <div className="accordion-item" key={index}>
              <h2 className="accordion-header" id={`heading-${index}`}>
                <button
                  className={`accordion-button bg-primary fw-bold text-white collapsed`}
                  type="button"
...
const accordionData = [
  {
    ...
    content: `
      <p><strong>Khelobro</strong> charges a minimal platform commission on every contest. This helps us maintain fair play and provide uninterrupted service to our users.</p>
  ...
  <h2>Khelobro - Terms and Conditions</h2>
  <p>
    These terms and conditions of use (“Terms”) along with our Privacy Policy form a legally binding agreement (“Agreement”) between you (“User”) and us ("Khelobro") operating at <a href="https://khelobro.online" target="_blank">https://khelobro.online</a>.
  </p>
  <p>
  ...
  <ol>
    <li>
      By using the Khelobro app or platform, you accept and agree to this Agreement by:
      <ul>
  ...
  <ol>
    ...
    <li>
      Khelobro offers <strong>games of skill</strong> (like Ludo). We do <strong>not</strong> support games of chance for money.
    </li>
    <li>
  ...
  <p>
    By continuing to use <strong>Khelobro</strong>, you acknowledge and agree to these Terms. Any misuse or violation of the Terms may result in account suspension or ban.
  </p>

  <p>
    For questions or support, email us at <a href="mailto:support@khelobro.online">support@khelobro.online</a> or visit our <a href="https://khelobro.online/chat" target="_blank">Contact Page</a>.
  </p>
</div>
  ...
  },
  {
    ...
    content: `
      ...
      <p>In case of a technical error or server issue, the match may be cancelled and the entry amount will be refunded to your Khelobro wallet.</p>
  ...
  <p>
    At <strong>Khelobro</strong>, we are committed to promoting <strong>responsible play</strong>. We encourage players to enjoy skill-based gaming as a form of entertainment, and support those who wish to take a break or set limits on their gameplay.
  </p>
  ...
  <p>
    In line with the <strong>Finance Act, 2023</strong>, the following <strong>Tax Deducted at Source (TDS)</strong> policy is applicable for all players on <strong>Khelobro</strong> from <strong>April 1, 2023</strong>.
  </p>
  ...
  <div class="alert alert-warning">
    <strong>Note:</strong> This policy is based on Finance Act, 2023. Khelobro reserves the right to modify the policy as per legal requirements.
  </div>
  ...
  <p class="text-muted">
    For queries or clarifications, please contact support at <a href="mailto:support@khelobro.online">support@khelobro.online</a> or visit our <a href="https://khelobro.online/chat" target="_blank">Contact Page</a>.
  </p>
</div>
    ...
    <div class="card mt-4">
      ...
      <div class="card-body">
        <div class="d-flex justify-content-between mb-2">
          <span class="small">Deposit Amount (Excl. Govt. Tax) <span class="badge bg-primary">A</span></span>
          <span>₹ 78.13</span>
        </div>
  ...
  <p>
    This Privacy Policy explains how <strong>Khelobro</strong> (https://khelobro.online) collects, uses, stores, and shares your personal information. By accessing or using our services, you agree to the terms of this policy. If you disagree with any part, please do not use the platform.
  </p>
  ...
  <p>
    If you allow location sharing, Khelobro may use it to offer location-specific services or personalization.
  </p>
  ...
  <p>
    For any questions, contact us at: <a href="mailto:support@khelobro.online">support@khelobro.online</a>
  </p>
</div>
    `,
  },
...
<p><b>Khelobro</b> is a skill-based real-money gaming platform accessible only for our users in India. It is accessible on https://moneyludo.com. On Khelobro, users can compete for real cash in Tournaments and Battles. They can encash their winnings via popular options such as Paytm Wallet, UPI or Phonepe.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p><strong>Email:</strong> <a href="mailto:grievance@khelobro.online">grievance@khelobro.online</a></p>
  ...
  },
  {
    ...
    content: `
      ...
      <p><strong>Email:</strong> <a href="mailto:support@khelobro.online">support@khelobro.online</a><br/>
